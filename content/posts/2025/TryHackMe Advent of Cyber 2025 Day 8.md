---
title: TryHackMe Advent of Cyber 2025 Day 8
summary: Walkthrough of the TryHackMe Advent of Cyber 2025 Day 8 - Prompt Injection - Sched-yule conflict
date: 2025-12-11
categories:
  - walkthrough
tags:
...
When an LLM is inventing facts, this is called **hallucination**. 
...
This is how it works under the hood, it feel like it's magic or the AI really understand what a human is saying but it's not the case. The LLM is just good at predicting the next word because it have been trained with billions of words. You have no idea of the amount of books, blog posts or social media posts ChatGPT "knows" (same for the other well known LLMs).
...
>With what we have learned, let's now try to help Wareville and see if we can restore SOC-mas. Open a browser in your AttackBox and access the Wareville Calender under `http://10.48.183.77`.
...
# Conclusion
This room is really cool, now I want to learn even more about LLMs !

You can try the extra room if you want and remember, never stop learning. 
