---
title: TryHackMe Advent of Cyber 2025 Day 10
summary: Walkthrough of the TryHackMe Advent of Cyber 2025 Day 10 SOC Alert Triaging - Tinsel Triage
date: 2025-12-13
categories:
  - walkthrough
tags:
  ...
  - AdventOfCyber2025
cover:
  image: /2025/aoc_2025_day_10/Advent_of_Cyber_2025_Day_10_cover.png
  hidden: false
...
| **Username**                           | **Temporary Access Pass** |
| -------------------------------------- | ------------------------- |
| usr-aoc25@tryhackme.onmicrosoft.com    | `#^4J7DP+RM#5S2Z-`        |
| usr-aoc25-af@tryhackme.onmicrosoft.com | `r&YALdCw^qBkQtf$`        |
| usr-aoc25-as@tryhackme.onmicrosoft.com | `bA=MsHD5j=cKt3Mp`        |
| usr-aoc25-eu@tryhackme.onmicrosoft.com | `KyYUbCDz568w8GJK`        |
| usr-aoc25-na@tryhackme.onmicrosoft.com | `cduZELyG97GkPbrS`        |
| usr-aoc25-sa@tryhackme.onmicrosoft.com | `2NR67nYmKn6TKjaa`        |
| usr-aoc25-oc@tryhackme.onmicrosoft.com | `HS%&9YSB%TNM9A36`        |
>This will take you directly to the  [Microsoft Azure](https://portal.azure.com/) portal.

![Microsoft Sign In page](https://tryhackme-images.s3.amazonaws.com/user-uploads/5f9c7574e201fe31dad228fc/room-content/5f9c7574e201fe31dad228fc-1759243758498.png)

![Login with Temporary Access Pass.](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efbaebdaaea011c857b438d/room-content/5efbaebdaaea011c857b438d-1761753973488.png)
...
![](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e9c5d0148cf664325c8a075/room-content/5e9c5d0148cf664325c8a075-1765496772588.png)

>**Note 2**: In case you see no incidents, ensure you have set a custom date range for the incidents:

![](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e9c5d0148cf664325c8a075/room-content/5e9c5d0148cf664325c8a075-1765646678451.png)
...
How many entities are affected by the **Linux PrivEsc - Polkit Exploit Attempt** alert? - It's in the "entries" field.

What is the severity of the **Linux PrivEsc - Sudo Shadow Access** alert? - High.

How many accounts were added to the sudoers group in the **Linux PrivEsc - User Added to Sudo Group** alert? - Open the entries field and look at the number of accounts.
...
What is the name of the kernel module installed in websrv-01? - malicious....

What is the unusual command executed within websrv-01 by the ops user? - /bin/bash -i...

What is the source IP address of the first successful SSH login to storage-01? - 172.xx.x.xx

What is the external source IP that successfully logged in as root to app-01? - 203.x.xxx.xx

Aside from the backup user, what is the name of the user added to the sudoers group inside app-01? - dep...

To answer the questions, change the "where host_s" value + use the search bar to speed up the process ! 

# Conclusion

I love how TryHackMe evolved, we are truly learning meaningful skills.

Take your time and remember, never stop learning.
