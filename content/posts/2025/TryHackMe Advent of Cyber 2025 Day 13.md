---
title: TryHackMe Advent of Cyber 2025 Day 13
summary: Walkthrough of the TryHackMe Advent of Cyber 2025 Day 13 YARA Rules - YARA mean one!
date: 2025-12-14T16:30:00
categories:
  - walkthrough
tags:
  - blue teaming
  ...
  - AdventOfCyber2025
cover:
  image: /2025/aoc_2025_day_13/Advent_of_Cyber_2025_Day_13_cover.png
  hidden: false
...
It's a tool created by VirusTotal and used by a plethora of well known organizations like Avast, Kaspersky Lab, Trend Micro, Tenable... 
You can find the official website [here](https://virustotal.github.io/yara/). 
...
Create a YARA rule like asked, the number of images will appear.
...
Run the YARA rule with the previous regex and build the message from the smallest number to the biggest one.
