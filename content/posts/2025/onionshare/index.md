...
description: "This article explains how to securely send sensitive files over the dark net using OnionShare. Learn step-by-step instructions and understand the importance of privacy and anonymity in digital communications"
date: 2025-10-09
categories: ["privacy"]
...
1. [Flatpak](https://flathub.org/apps/details/org.onionshare.OnionShare)
...
1. Open the software and click on "**Share Files**" ![](1.png)
2. Here you can drag and drop the files/directories you want to share or click on "**add**" ![](2.png)
3. Once you add the files you want, you can click on "**Start Sharing**" ![](3.png)
4. This is going to generate a temporary **.onion link** and a **private key** that you will have to send to the recipient (ideally via an encrypted messaging app 😉) ![](4.png)
## Receive Files
Bob, the recipient got a link and a private key : 
1. He opens the **Tor Browser** and navigate to the link, and he will be prompted to enter the private key ![]((5.png)
2. Bob can now download the file ! ![](6.png)
