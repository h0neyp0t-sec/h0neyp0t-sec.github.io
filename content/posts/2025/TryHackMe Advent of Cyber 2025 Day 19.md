---
title: TryHackMe Advent of Cyber 2025 Day 19
summary: Walkthrough of the TryHackMe Advent of Cyber 2025 Day 19 - ICS/Modbus - Claus for Concern
date: 2025-12-19T17:40:00
categories:
  - walkthrough
tags:
  - blue teaming
  ...
  - AdventOfCyber2025
cover:
  image: /2025/aoc_2025_day_19/Advent_of_Cyber_2025_Day_19_cover.png
  hidden: false
...
```shell-session
root@tryhackme:~# nmap -sV -p 22,80,502 10.82.157.33
...
```shell-session
root@tryhackme:~# nmap -sV -T4 -p- -vv 10.82.157.33
```
...
>Navigate to `http://10.82.157.33` in your browser.
...
>>> client = ModbusTcpClient('10.82.157.33', port=502)
>>> 
...
>Excellent work! Now check the CCTV feed at `http://10.82.157.33` - you should see King Malhare's defeat displayed.
...
# Questions
## What's the flag? - `THM{eGgMas****}`

# Conclusion
Wow, that was lot of new things to read. Consider completing the OT challenge: [Industrial Intrusion](https://tryhackme.com/jr/industrial-intrusion) and remember to wear warm clothes. 
